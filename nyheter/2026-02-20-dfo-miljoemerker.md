...
<h3 style="color: #2C5F2D;">Hva kravene faktisk dekker</h3>
...
- Indirekte sammenheng med miljøprestasjonen i den konkrete tjenesten
- På noen områder strengere enn Svanemerket – blant annet krav om nullutslippskjøretøy
...
<h2 style="color: #2C5F2D;">Tilknytningsproblemet</h2>
...
Miljøledelse kan være relevant, men bør normalt håndteres som kvalifikasjon eller som kontraktskrav. Skal det inngå i evalueringen av ytelsen, må det knyttes til konkrete, målbare forpliktelser i kontrakten.

<h2 style="color: #2C5F2D;">Konsekvenser for konkurranse og miljøambisjon</h2>
...
<h2 style="color: #2C5F2D;">Tre forslag</h2>
...
- DFØ: Anbefalte miljøkrav for renholdstjenester og -produkter (anskaffelser.no, 2024)
- DFØ: Veileder til regler om klima- og miljøhensyn i offentlige anskaffelser (2024)
- DFØ: Bruk av miljømerker, miljøvaredeklarasjoner og miljøledelsessystem i anskaffelser
- Gulsvik, A.A.: «Det beste må ikke bli det godes verste fiende», Anbud365 (2022)
- EU-domstolen, sak C-448/01 (Wienstrom)
- Anskaffelsesforskriften (FOA) §§ 7-9, 15-1
- Stiftelsen Miljøfyrtårn: Felleskriterier og bransjekrav (2019)
- Nordisk Miljømerking: Kriteriedokument 076 (Renholdstjenester)
